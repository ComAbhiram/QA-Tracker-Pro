...
export default function AssigneeTaskTable({
    ...
    dateFilter, onEditTask, onFieldUpdate, onLeaveUpdate, onAddTask, selectedTeamId, onResizeStart,
                ...
                <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300">
                    ...
                    {onAddTask && !isReadOnly && (
                        <button
                            ...
                            className="p-1.5 bg-white/60 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-700 rounded-md border border-black/5 dark:border-slate-700 text-indigo-600 dark:text-indigo-400 transition-all hover:scale-110 active:scale-95 shadow-sm"
